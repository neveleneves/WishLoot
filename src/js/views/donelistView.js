...
class DonelistView extends View {
                ...
                <div class="product-panel">
                    ...
                    <div class="wrapper-done-button">
                        <a class="done-button product-button">
                            <svg class="product-svg" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.52441 11.3445L10.8101 14.9159L16.5244 7.77305M11.5244 21.3445C6.00157 21.3445 1.52441 16.8673 1.52441 11.3445C1.52441 5.82163 6.00157 1.34448 11.5244 1.34448C17.0473 1.34448 21.5244 5.82163 21.5244 11.3445C21.5244 16.8673 17.0473 21.3445 11.5244 21.3445Z" stroke="#06924c" stroke-width="2.5"/>
                            </svg> 
                        </a>
                    </div>
                </div>
